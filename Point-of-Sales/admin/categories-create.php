            ...
            <form action="code.php" method="POST">
                <div class="row">
                    <div class="col-md-12 mb-3">
                        ...
                        <input type="text" name="name" required class="form-control" style="background-color:#D9D9D9;" placeholder="Masukkan Nama Kategori" />
                    </div>
                    <div class="col-md-12 mb-3">
                        <label for="">Deskripsi</label>
                        <textarea name="description" class="form-control" rows="3" style="background-color:#D9D9D9;" placeholder="Masukkan Deskripsi Kategori (Opsional)"></textarea>
                    </div>
                    ...
                    <div class="col-md-6 text-end mb-2">
                        <br>
                        <button type="submit" name="saveCategory" class="btn btn-success" style="width: 150px;"><i class="fa-solid fa-floppy-disk me-2"></i>Simpan</button>
                    </div>
                </div>
            </form>
        </div>
